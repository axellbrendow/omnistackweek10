...
// All screens receive this navigation object
...
const styles = StyleSheet.create({
    ...
    searchInput: {
        ...
        fontSize: 16,
        shadowColor: '#000', // These are the properties to create a shadow in iOS
        shadowOpacity: 0.2,
        shadowOffset: {
            width: 4,
            height: 4,
        },
        elevation: 2, // This is the way to do a shadow in android
    },
